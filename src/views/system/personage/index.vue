          ...
          <div class="text-13px text-#303133 dark:text-#E5EAF3">
            ...
            <div class="flex flex-justify-between flex-wrap p-y-12px">
              <div class="flex flex-items-center">
                ...
                <div class="p-l-2px">性别</div>
              </div>
              <div v-text="getSexText(mine.sex)"></div>
            </div>
            <div class="flex flex-justify-between flex-wrap p-y-12px">
              <div class="flex flex-items-center">
                <el-icon size="15">
                ...
                <div class="p-l-2px">个人描述</div>
              </div>
              <div v-text="mine.description"></div>
            </div>
            <!--            <div class="flex flex-justify-between flex-wrap p-y-12px">-->
            <!--              <div class="flex flex-items-center">-->
            ...
            <div class="flex flex-justify-between flex-wrap p-y-12px">
              ...
              <div v-text="formatDateTime(mine.createDate)"></div>
            </div>
          </div>
        </el-card>
      </el-col>
                ...
                <el-row>
                  <el-col :sm="{ span: 24 }" :xs="{ span: 24 }">
                    <el-form-item label="登录名称" prop="nickname">
                      <el-input v-model="mineForm.nickname" placeholder="请输入登录名称" clearable />
                    </el-form-item>
                  </el-col>
                  <el-col :sm="{ span: 24 }" :xs="{ span: 24 }">
                    <el-form-item label="用户名称" prop="username">
                      <el-input v-model="mineForm.username" placeholder="请输入用户名称" clearable />
                    </el-form-item>
                  </el-col>
                  <el-col :sm="{ span: 24 }" :xs="{ span: 24 }">
                    <el-form-item label="个人描述" prop="description">
                      <el-input v-model="mineForm.description" placeholder="请输入个人描述" clearable />
                    </el-form-item>
                  </el-col>
                  <el-col :sm="{ span: 24 }" :xs="{ span: 24 }">
...
//   sex: "3"
// });
let mineForm = ref(userStore.user);
/** 清空表单数据 */
const resetMineForm = () => {
  // 等待 DOM 更新完成
  nextTick(() => {
...
const mineRules = reactive({
  ...
  nickname: [{ required: true, message: "请输入登录名称", trigger: "blur" }],
...
const handleMineSave = () => {
  ...
  (mineFormRef.value as any).validate(async (valid: any) => {
    const res = await update(mineForm.value)
    if (valid) {
      koiMsgSuccess("保存成功🌻");
    } else {
